            ...
            <div className={styles.modalMoveContent}>
                <div className={styles.headerMove}>
                    ...
                    <div onClick={props.closeMove} className={styles.close}>&#215;</div>
                     ...
                     <select className={styles.select}  value={value} onChange={e => setValue(+e.target.value-1)}>
                     ...
                     <select className={styles.select} value={valueList}  onChange={e => setValueList(+e.target.value)}>
